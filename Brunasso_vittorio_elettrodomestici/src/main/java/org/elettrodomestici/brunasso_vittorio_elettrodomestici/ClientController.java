...
public class ClientController {
    ...
    @FXML
    private Button btnAggiungi, btnVaiAlCarrello, btnVaiAlPreventivo; // Aggiunto pulsante per il preventivo
    @FXML
    ...
    public void initialize() {
        ...
        btnVaiAlCarrello.setOnAction(new VaiAlCarrelloHandler());
        btnVaiAlPreventivo.setOnAction(new VaiAlPreventivoHandler());  // Aggiunto handler per il preventivo
    ...
    class VaiAlCarrelloHandler implements EventHandler<ActionEvent> {
        public void handle(ActionEvent event) {
            try {
                Stage stage = (Stage) btnVaiAlCarrello.getScene().getWindow();
                stage.setScene(new Scene(FXMLLoader.load(getClass().getResource("/org/elettrodomestici/brunasso_vittorio_elettrodomestici/carrello_view.fxml"))));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    class VaiAlPreventivoHandler implements EventHandler<ActionEvent> {
        public void handle(ActionEvent event) {
            try {
                Stage stage = (Stage) btnVaiAlPreventivo.getScene().getWindow();
